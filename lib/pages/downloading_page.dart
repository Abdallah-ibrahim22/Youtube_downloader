                    ...
                    children: [
                      _video == null
                          ? Container(
                              ...
                              child: picLoading && link.isNotEmpty
                          ...
                          : Column(
                              children: [
                                ...
                                ListTile(
                                  ...
                                  subtitle:
                                      Text(_video.description, maxLines: 2),
                                ),
                              ],
                            ),
                      const SizedBox(height: 20),
                      Padding(
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (value) async {
                            ...
                            await fetchVideoThumbnail(link);
                            await getAudioData(link);
                            picLoading = false;
                            setState(() {});
                          },
                      ...
                      link.isEmpty
                          ? const SizedBox()
                          : audioData.isEmpty ? const SizedBox():
